...
class MedicalNoteProvider with ChangeNotifier {
  ...
  Future<void> addMedicalNote(MedicalNote note) async {
  await _noteService.saveMedicalNote(note);  // Guarda en Firestore
  _notes.add(note);                                // Agrega a la lista local
  notifyListeners();                               // Notifica para actualizar UI
}
